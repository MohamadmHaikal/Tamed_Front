            ...
            <div class="overview-box">
                <div class="overview-content">
                    <div class="content left-content">
                        <h2>أهم الميزات للعضوية في منصة تعميد</h2>
                        <div class="bar"></div>
                        <p>  تقدم منصة تعميد العديد من الميزات لعضويات الأعمال لتسهل عليهم ادارة مشاريعهم وعقودهم
                            من خلال المنصة بميزيات متقدمة وسلسه</p>
