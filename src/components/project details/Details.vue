<template>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-9 col-sm-12 ">
                                    <span><i class="fas fa-star pr-2"
                                            style="color:#5b429d ; font-size: 17px;padding-left: 10px;"></i>0
                                        <span style="color:#9d9dab;">(لايوجد تقييمات)</span></span>
    ...
    margin-right: 10px;"></i>
                                ...
                                <div class="col-md-3 col-sm-12 text-center fav-share">
                                    ...
                                    <span style=" margin-right: 6px; margin-bottom:2px ;">المفضلة</span>

                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
                                        style="enable-background:new 0 0 512 512; width: 20px;margin-right: 20px;"
                                        xml:space="preserve">
                                        <g>
                                            <polygon
		...
		c25.3,0,44.7,19.3,44.7,44.7v267.9C449.5,492.6,430.1,512,404.8,512z" />
                                    ...
                                    <span style=" margin-right: 6px; margin-bottom:2px ;">المشاركة</span>
    ...
    padding-left: 0px;">
                                    ...
                                    <div class="col-md-12 mt-4">
                                                ...
                                                <div class="row"
                                                    ...
                                                    <div class="col-md-4 col-sm-4 conditional"
                                                        style="padding-right:0px ; padding-left:0px ;"><svg
                                                            ...
                                                            style="color:#c2c2c2 ; padding-right: 5px; padding-left:0px ;">هل
                                                            يوجد
                                                            سكن</span> <span
                                                    ...
                                                    <div class="col-md-4 conditional" style="padding-right:0px ;margin-right:0px;">
                                                        <i class="fa fa-bus"
                                                            style="    font-size: 25px;  color: #039ca4; margin-top: 15px;"></i>
                                                        <span style="color:#c2c2c2 ; padding-right: 5px;">هل تتوفر
                                                            مواصلات</span>
                                        ...
                                        <div id="Paris" class="tabcontent">
                                            ...
                                            <table
                                                ...
                                                <tr>
                                                    <td style=" border-right: 1px solid #ccc; border-top: 1px solid #ccc; border-top-right-radius: 20px;">
                                                    ...
                                                    <td style=" border-top: 1px solid #ccc;    border-left: 1px solid #ccc; border-right: 1px solid #ccc; border-top-left-radius: 20px;">
                                                        <div style="padding: 30px;"><img
                                                                src="../../assets/images/3d.png" alt=""> <span
                                                                style=" color:#019aa2;  padding-right: 2px;  font-size: 20px;">
                                                                <a href="javascript:void(0);"
                                                                    style=" color:#019aa2;">تحميل</a></span>
                                                        </div>
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <div style="padding: 30px;"><img
                                                                src="../../assets/images/Excel.png" alt=""> <span
                                                                style=" color:#019aa2; padding-right: 2px;   font-size: 20px;">
                                                                <a href="javascript:void(0);"
                                                                    style=" color:#019aa2;">تحميل</a></span>
                                                        </div>
                                                    ...
                                                    <td style="border: 1px solid #ccc;border-bottom-left-radius: 20px;">
                                                        <div style="padding: 30px;"><img
                                                                src="../../assets/images/autoca.png" alt=""> <span
                                                                style=" color:#019aa2;   padding-right: 2px; font-size: 20px;">
                                                                <a href="javascript:void(0);"
                                                                    style=" color:#019aa2;">تحميل</a></span>
                                                        </div>
                            ...
                            <div class="col-md-5 col-sm-12 price-card">
                                <div
                                    ...
                                    <div style="border-bottom: 1px solid #eeeff1 ;">
                                        <h5 style="padding-top: 8%;text-align: right;padding-right: 10%;">قيمة المشروع
                                        </h5>
                                ...
                                <div
                                    ...
                                    <div style="border-bottom: 1px solid #eeeff1 ;">
                                        <h5 style="padding-top: 8%;text-align: center;    font-size: 95%;">معلومات صاحب
                                            الطلب
                                        </h5>


                                    </div>
                                    <div class="mt-3" style="text-align: center;  padding-bottom: 15px; ">
                            ...
                            <h5 class="title">مشاريع مشابهة</h5>
                        </div>
