        ...
        <footer class="footer-area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-sm-6 col-md-6">
                        <div class="single-footer-widget">
                            <div class="logo">
                                <router-link to="/"><img src="../../assets/images/tamed-1.png" alt="logo"></router-link>
                ...
                <div class="copyright-area">
                    <div class="row">
                        <div class="col-md-4">
                            <p style="border-left: solid 1px;" class="parColor">جميع الحقوق محفوظة ©2021-منصةتعميد-المملكة العربية السعودية</p>
                            <span class="parColor">يدعم المتصفحات</span><img src="../../assets/images/125.png"  >
                        </div>
                        <div class="col-md-2">
                            <p  style="border-left: solid 1px;" class="parColor">سياسة الاستخدام</p>
                        </div>
                        <div class="col-md-2">
                            <p class="parColor">سياسة الخصوصية</p>
                        </div>
                         <div class="col align-self-center">
                             <img src="../../assets/images/stars-tech.png"  alt="">
                        </div>
                    </div>
